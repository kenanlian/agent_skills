...
- why the gap blocks implementation or verification; and
- the exact decision or information needed.
...
- Required revisions: only blocking gaps, grouped by plan task or section. Omit this section when approving.
- Non-blocking risks: at most two explicitly labeled observations that do not change the verdict.

When approving, state which source references and verification criteria were checked. When revising, do not include design preferences or vague requests for more detail.
