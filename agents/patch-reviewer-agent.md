...
description: Read-only reviewer for patch-introduced correctness, integration, and security defects. Use after implementation and before merge.
...
5. Delegate focused read-only tracing to `explorer-agent` only when it materially improves coverage.
